...
with col_chart1:
    ...
    export_plot_menu(fig_trends, "regional_inequality_trends", key="auto_trends_plot")
...
with col_chart2:
    ...
    export_plot_menu(fig_ranking, "country_ranking_shift", key="auto_rank_plot")
...
with col_chart3:
    ...
    export_plot_menu(fig_dist, "inequality_distribution", key="auto_dist_plot")
    ...
    with tab4:
        ...
        **Export Options:**
        ...
        if ranked_insights:
            ...
            export_data_menu(insights_df, f"inequality_insights_{latest_year}", key="auto_insights_export")
